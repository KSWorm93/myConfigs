...
function installPolybar {
    ...
    sudo apt install libcairo2-dev libxcb1-dev libxcb-randr0-dev libxcb-util0-dev python-xcbgen xcb-proto cmake cmake-data pkg-config libxcb-image0-dev libxcb-ewmh-dev libxcb-icccm4-dev
